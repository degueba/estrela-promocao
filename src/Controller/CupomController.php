                    ...
                    if(!$notaModel->findNota($nota)){
                        ...
                        if($valorProdutos >= VALOR_GASTO_POR_CUPOM){
                            ...
                            $mail->Body    = '<table class="display: block; margin; 0 auto;" align="center">
                                            ...
                                            font-size: 25px;
                                            margin: 30px auto;">
                                                            Oi, '.Session::logado()['nome'].'! <br> 
                                                            Você ganhou número(s) da sorte para concorrer a uma viagem de volta ao mundo! Confira o regulamento da promo&ccedil;&atilde;o e BOA SORTE!
                                                            <br><br> 
                                                            '.$cuponsDistribuidos.'
                                                            <br>
                                                        </p>
